...
class GodkjenningBGSv2 {
    ...
    private OppgaveOversiktv2 oversikt;
    public GodkjenningBGSv2(OppgaveOversiktv2 oversikt) {
...
class Oppgave1v2 {
    public static void main(String[] args) {
        ...
        OppgaveOversiktv2 oversikt = new OppgaveOversiktv2();
        GodkjenningBGSv2 bgs = new GodkjenningBGSv2(oversikt);
